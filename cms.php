...
if (!empty($pricesRows)) {
    ...
    $priceList = [
        'Henna Series' => [
            ['name'=>'Brow Henna',          'price'=>'Rp 25.000',           'desc'=>'','image'=>''],
            ['name'=>'Nail Henna Tangan',   'price'=>'Rp 25.000',           'desc'=>'','image'=>''],
            ['name'=>'Nail Henna Kaki',     'price'=>'Rp 30.000',           'desc'=>'','image'=>''],
            ['name'=>'Bundling Meni-Henna', 'price'=>'Rp 75.000',           'desc'=>'','image'=>''],
            ['name'=>'Henna Fun',           'price'=>'Rp 25.000 - 100.000', 'desc'=>'','image'=>''],
        ],
        'Treatment Spa' => [
            ['name'=>'Bundling Manicure & Pedicure','price'=>'Rp 100.000',          'desc'=>'','image'=>''],
            ['name'=>'Manicure / Pedicure',         'price'=>'Rp 60.000',           'desc'=>'','image'=>''],
            ['name'=>'Hand Spa',                    'price'=>'Rp 80.000',           'desc'=>'','image'=>''],
            ['name'=>'Foot Spa',                    'price'=>'Rp 100.000',          'desc'=>'','image'=>''],
            ['name'=>'Callus Treatment',            'price'=>'Rp 70.000 - 150.000', 'desc'=>'','image'=>''],
        ],
        'Brow & Lash' => [
            ['name'=>'Brow Bomb',    'price'=>'Rp 100.000','desc'=>'','image'=>''],
            ['name'=>'Lashlift',     'price'=>'Rp 70.000', 'desc'=>'','image'=>''],
            ['name'=>'Lashlift Tint','price'=>'Rp 90.000', 'desc'=>'','image'=>''],
        ],
        'Rambut' => [
            ['name'=>'Creambath',        'price'=>'Rp 75.000',            'desc'=>'','image'=>''],
            ['name'=>'Hair Mask',        'price'=>'Rp 45.000 - 90.000',  'desc'=>'','image'=>''],
            ['name'=>'Hair Spa',         'price'=>'Rp 100.000',           'desc'=>'','image'=>''],
            ['name'=>'Cuci,Catok,Blow',  'price'=>'Rp 25.000 - 50.000',  'desc'=>'','image'=>''],
            ['name'=>'Bleaching S',      'price'=>'Rp 40.000',            'desc'=>'','image'=>''],
            ['name'=>'Coloring Full',    'price'=>'Rp 120.000 - 300.000', 'desc'=>'','image'=>''],
            ['name'=>'Bleaching',        'price'=>'Rp 200.000 - 1.200.000','desc'=>'','image'=>''],
            ['name'=>'Balayage',         'price'=>'Rp 250.000 - 700.000', 'desc'=>'','image'=>''],
            ['name'=>'Down Peim Poni',   'price'=>'Rp 100.000 - 300.000', 'desc'=>'','image'=>''],
            ['name'=>'Keriting Klasik',  'price'=>'Rp 300.000 - 700.000', 'desc'=>'','image'=>''],
            ['name'=>'Keriting Digital', 'price'=>'Rp 450.000 - 1.700.000','desc'=>'','image'=>''],
            ['name'=>'Keratin Treatment','price'=>'Rp 200.000',           'desc'=>'','image'=>''],
            ['name'=>'Smoothing',        'price'=>'Rp 200.000 - 400.000', 'desc'=>'','image'=>''],
        ],
        'Nail Art & Services' => [
            ['name'=>'Press On Nail Basic',          'price'=>'Rp 50.000', 'desc'=>'','image'=>''],
            ['name'=>'Press On Nail Motif',          'price'=>'Rp 75.000', 'desc'=>'','image'=>''],
            ['name'=>'Kids Basic Gel',               'price'=>'Rp 40.000', 'desc'=>'','image'=>''],
            ['name'=>'Kids Gel + 4 Sticker',         'price'=>'Rp 50.000', 'desc'=>'','image'=>''],
            ['name'=>'Kids Gel + Full Sticker',      'price'=>'Rp 55.000', 'desc'=>'','image'=>''],
            ['name'=>'Gel Basic Tangan / Kaki',      'price'=>'Rp 85.000', 'desc'=>'','image'=>''],
            ['name'=>'Extension',                    'price'=>'Rp 50.000', 'desc'=>'','image'=>''],
            ['name'=>'Gel French / Cat Eyes',        'price'=>'Rp 105.000','desc'=>'','image'=>''],
            ['name'=>'Remove Gel',                   'price'=>'Rp 50.000', 'desc'=>'','image'=>''],
            ['name'=>'Gel Ombre / Blush On',         'price'=>'Rp 135.000','desc'=>'','image'=>''],
            ['name'=>'Remove Extension',             'price'=>'Rp 65.000', 'desc'=>'','image'=>''],
            ['name'=>'Bundling Nail Art + Extension','price'=>'Rp 150.000','desc'=>'','image'=>''],
        ],
    ];
}
